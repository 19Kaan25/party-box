  ...
  const calculateDynamicScores = () => {
    ...
    categories.forEach(cat => {
      ...
      Object.entries(allAnswers).forEach(([pid, ansObj]) => {
        ...
        // GEÄNDERT: Die Überprüfung, ob das Wort mit dem richtigen Buchstaben anfängt,
        // wurde hier entfernt. Solange das Wort nicht aktiv abgelehnt wurde, ist es gültig.
        if (word && !isRejected) {
