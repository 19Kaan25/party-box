...
import { Users, Play, Trophy, Copy, Check, LogOut, Settings, AlertCircle, ArrowRight, Plus, Trash2, Dices, List, X, ThumbsDown, Files, Search, Pin, PinOff, Moon, Sun, Skull, Heart, Shield, RefreshCw, HeartHandshake } from 'lucide-react';
...
// --- Game Engine: Werwolf ---
function WerwolfEngine({ lobby, user, isHost, db, updateLobbyStatus, leaveLobby }) {
  const { gameState, players, id: lobbyCode } = lobby;
          ...
          <div className="max-w-6xl mx-auto w-full grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-3 bg-slate-800 rounded-3xl p-6 border border-slate-700 shadow-xl">
              <div className="flex justify-between items-center mb-6 border-b border-slate-700 pb-4">
                ...
                {isHost && (
                  <button onClick={() => updateLobbyStatus('LOBBY_WAITING', null, { gameState: {} })} className="text-xs bg-red-900/50 hover:bg-red-900 text-red-300 px-3 py-1.5 rounded transition-colors">
                    Spiel abbrechen
                  </button>
                )}
              </div>
