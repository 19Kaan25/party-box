...
-- Datenbank bleibt unveraendert. Ausfuehren als postgres/service_role, z. B.
--
--   psql "$DATABASE_URL" -v ON_ERROR_STOP=1 -f scripts/verify-phase0a.sql
--
-- Jede Pruefung ist ein assert. Faellt eine, bricht das Skript ab.
--
...
-- Alles ok, wenn oben keine Assertion gefeuert hat und hier ROLLBACK steht.
